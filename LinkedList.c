        ...
        for(int i=0;i<ll_len(this);i++)
        {
            pElement=ll_get(this,i);
                if(pElement!=NULL)
                {
                    ...
                    acumulador=acumulador+returnAux;
                }
        }
    }
 ...
 * \param this LinkedList* Puntero a la lista
 * \param fn (*fn) Puntero a la funcion criterio
 * \return int Retorna  la lista creada.
 */
 ...
 * \return int Retorna  la lista creada.
 */
LinkedList* ll_filter_parametro(LinkedList* this, int (*fn)(void*,char*),char* cadena)
{
    int returnAux =-1;
    void* pElement;
    LinkedList* pArrayFilter=NULL;
